 ...
 * Acesso: Catálogo, Reservas, Conquistas, Perfil
...
export const SidebarAluno = () => {
  ...
  const navLinks = [
    { href: '/aluno/dashboard', icon: BookOpen, label: 'Dashboard' },
    { href: '/catalogo', icon: BookOpen, label: 'Catálogo' },
    { href: '/aluno/meus-livros', icon: BookMarked, label: 'Meus Livros' },
    { href: '/aluno/minhas-reservas', icon: BookMarked, label: 'Minhas Reservas' },
    { href: '/aluno/conquistas', icon: Award, label: 'Conquistas' },
